...
import com.Tienda.service.IRegistroService;
...
public class RegistroService implements IRegistroService {
    ...
    public Model crearUsuario(Model model, Usuario usuario) 
        ...
        if (!usuarioService.
            ...
            usuarioService.save(usuario, true);
            enviaCorreo(usuario, clave, "activar");
...
//    }
    ...
    //Pasando los dos métodos anteriores a uno, pasando la información por parámetro.
    
    @Value("${servidor.http}")
private String servidor;

private void enviaCorreo(Usuario usuario, String clave, String tipoCorreo) throws MessagingException {
    String mensajeKey, asuntoKey;

    if (tipoCorreo.equals("activar")) {
        mensajeKey = "registro.correo.activar";
        asuntoKey = "registro.mensaje.activacion";
    } else if (tipoCorreo.equals("recordar")) {
        mensajeKey = "registro.correo.recordar";
        asuntoKey = "registro.mensaje.recordar";
    } else {
        throw new IllegalArgumentException("Tipo de correo no válido");
    }
